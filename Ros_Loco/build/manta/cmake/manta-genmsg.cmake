...
message(STATUS "manta: 4 messages, 0 services")

set(MSG_I_FLAGS "-Imanta:/home/test/Manta/Ros_Loco/src/manta/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/test/Manta/Ros_Loco/src/manta/msg/Warmdepth.msg" NAME_WE)
add_custom_target(_manta_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "manta" "/home/test/Manta/Ros_Loco/src/manta/msg/Warmdepth.msg" ""
)

get_filename_component(_filename "/home/test/Manta/Ros_Loco/src/manta/msg/MotorCommandMsg.msg" NAME_WE)
add_custom_target(_manta_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "manta" "/home/test/Manta/Ros_Loco/src/manta/msg/MotorCommandMsg.msg" ""
)

get_filename_component(_filename "/home/test/Manta/Ros_Loco/src/manta/msg/PropellerCommandMsg.msg" NAME_WE)
add_custom_target(_manta_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "manta" "/home/test/Manta/Ros_Loco/src/manta/msg/PropellerCommandMsg.msg" ""
)

get_filename_component(_filename "/home/test/Manta/Ros_Loco/src/manta/msg/CommandMsg.msg" NAME_WE)
add_custom_target(_manta_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "manta" "/home/test/Manta/Ros_Loco/src/manta/msg/CommandMsg.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/manta)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/manta\")")
  # install generated code
  install(
