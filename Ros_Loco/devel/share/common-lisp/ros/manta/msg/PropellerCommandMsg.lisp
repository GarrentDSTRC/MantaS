...
(cl:defmethod cl:initialize-instance :after ((m <PropellerCommandMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PropellerCommandMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name manta-msg:<PropellerCommandMsg> is deprecated: use manta-msg:PropellerCommandMsg instead.")))
