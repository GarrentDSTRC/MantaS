...
class PropellerCommandMsg {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PropellerCommandMsg(null);
  ...
  static datatype() {
    ...
    return 'motion_control/PropellerCommandMsg';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PropellerCommandMsg(null);
    if (msg.ID !== undefined) {
      resolved.ID = msg.ID;
    }
    else {
...
module.exports = PropellerCommandMsg;
