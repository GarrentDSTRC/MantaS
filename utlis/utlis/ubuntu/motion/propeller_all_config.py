...
#     # 发送信号控制命令
#     def signal_control(self, motor_id, percentage):
...
#         vci_can_obj = self.VCI_CAN_OBJ(motor_id, 0, 0, 1, 0, 0, 4, data_array)
#         self.send_command(vci_can_obj)
...
#             self.signal_control(self.motor_id, percentage)
#             time.sleep(1)
...
#         for _ in range(duration):
#             self.speed_control(self.motor_id, speed)
#             time.sleep(1)
